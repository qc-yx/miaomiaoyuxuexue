...
async function testDataSharing() {
    ...
    try {
        ...
        const inviteCodeResponse = await axios.post(`${API_BASE_URL}/invite/create`, {}, {
        ...
        await axios.post(`${API_BASE_URL}/invite/bind`, {
            code: inviteCode
        }, {
        ...
        await axios.post(`${API_BASE_URL}/wheel/settings`, {
        ...
        const user1Settings = await axios.get(`${API_BASE_URL}/wheel/settings`, {
            headers: { Authorization: `Bearer ${user1Token}` }
        });
        console.log('📊 邀请者数据:', {
        ...
        const user2Settings = await axios.get(`${API_BASE_URL}/wheel/settings`, {
            headers: { Authorization: `Bearer ${user2Token}` }
        });
        console.log('📊 被邀请者数据:', {
